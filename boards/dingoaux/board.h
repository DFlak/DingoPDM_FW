 ...
 */
#define LINE_OUT1                   PAL_LINE(GPIOA, 0U)
#define LINE_OUT2                   PAL_LINE(GPIOA, 1U)
#define LINE_OUT3                   PAL_LINE(GPIOA, 2U)
#define LINE_BATT_SENSE             PAL_LINE(GPIOA, 3U)
#define LINE_THERM1                 PAL_LINE(GPIOA, 4U)
#define LINE_THERM2                 PAL_LINE(GPIOA, 5U)
#define LINE_THERM3                 PAL_LINE(GPIOA, 6U)
#define LINE_THERM4                 PAL_LINE(GPIOA, 7U)
#define LINE_I2C3_SCL               PAL_LINE(GPIOA, 8U)
#define LINE_USB_VBUS               PAL_LINE(GPIOA, 9U)
#define LINE_OUT4                   PAL_LINE(GPIOA, 10U)
#define LINE_USB_DM                 PAL_LINE(GPIOA, 11U)
#define LINE_USB_DP                 PAL_LINE(GPIOA, 12U)
#define LINE_SWDIO                  PAL_LINE(GPIOA, 13U)
#define LINE_SWCLK                  PAL_LINE(GPIOA, 14U)
#define LINE_OUT5                   PAL_LINE(GPIOA, 15U)
#define LINE_OUT6                   PAL_LINE(GPIOB, 0U)
#define LINE_OUT7                   PAL_LINE(GPIOB, 1U)
#define LINE_OUT8                   PAL_LINE(GPIOB, 2U)
...
#define LINE_OUT9                   PAL_LINE(GPIOB, 12U)
#define LINE_OUT10                  PAL_LINE(GPIOB, 13U)
#define LINE_OUT11                  PAL_LINE(GPIOB, 14U)
#define LINE_OUT12                  PAL_LINE(GPIOB, 15U)
#define LINE_LED_ERROR              PAL_LINE(GPIOC, 0U)
#define LINE_LED_STATUS             PAL_LINE(GPIOC, 1U)
#define LINE_OUT13                  PAL_LINE(GPIOC, 6U)
#define LINE_OUT14                  PAL_LINE(GPIOC, 7U)
#define LINE_OUT15                  PAL_LINE(GPIOC, 8U)
#define LINE_I2C3_SDA               PAL_LINE(GPIOC, 9U)
#define LINE_CAN_STANDBY            PAL_LINE(GPIOC, 12U)
#define LINE_UNUSED                 PAL_LINE(GPIOB, 11U)
#define LINE_DI1                    PAL_LINE(GPIOC, 2U)
#define LINE_DI2                    PAL_LINE(GPIOC, 3U)
#define LINE_DI3                    PAL_LINE(GPIOC, 4U)
#define LINE_DI4                    PAL_LINE(GPIOC, 5U)
 ...
 * GPIOA setup:
 *
 * PA0  - OUT1                      (output pushpull pulldown).
 * PA1  - OUT2                      (output pushpull pulldown).
 * PA2  - OUT3                      (output pushpull pulldown).
 * PA3  - BATT_SENSE                (analog in).
 * PA4  - THERM1                    (analog in).
 * PA5  - THERM2                    (analog in).
 * PA6  - THERM3                    (analog in).
 * PA7  - THERM4                    (analog in).
 * PA8  - I2C3_SCL                  (alternate 4, i2c scl).
 * PA9  - USB_VBUS                  (input pulldown).
 * PA10 - OUT4                      (output pushpull pulldown).
 * PA11 - USB_DM                    (alternate 10, usb dm).
 * PA12 - USB_DP                    (alternate 10, usb dp).
 * PA13 - SWDIO                     (alternate 0, swdio).
 * PA14 - SWCLK                     (alternate 0, swclk).
 * PA15 - OUT5                      (output pushpull pulldown).
 */
 ...
 * PB2  - OUT8                      (output pushpull pulldown, GPIO only, no PWM).
 ...
 * PB12 - OUT9                      (output pushpull pulldown, GPIO only, no PWM).
 * PB13 - OUT10                     (output pushpull pulldown, GPIO only, no PWM).
 * PB14 - OUT11                     (output pushpull pulldown).
 * PB15 - OUT12                     (output pushpull pulldown).
 */
 ...
 * GPIOC setup:
 *
 * PC0  - LED_ERROR                 (output pushpull pulldown).
 * PC1  - LED_STATUS                (output pushpull pulldown).
 * PC2  - DI1                       (input floating).
 * PC3  - DI2                       (input floating).
 * PC4  - DI3                       (input floating).
 * PC5  - DI4                       (input floating).
 * PC6  - OUT13                     (output pushpull pulldown).
 * PC7  - OUT14                     (output pushpull pulldown).
 * PC8  - OUT15                     (output pushpull pulldown).
 * PC9  - I2C3_SDA                  (alternate 4, i2c sda, opendrain).
 * PC10 - UNUSED                    (input floating).
 * PC11 - UNUSED                    (input floating).
 * PC12 - CAN_STANDBY               (output pushpull pulldown).
 * PC13 - UNUSED                    (input floating).
 * PC14 - UNUSED                    (input floating).
 * PC15 - UNUSED                    (input floating).
 */
...
/*
 * GPIOD setup:
 * NOTE: GPIOD pins are not available on the 64-pin STM32F446RET6 package.
 * All pins set to input pullup as safe defaults.
 *
