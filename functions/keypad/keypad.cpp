        ...
        (rx->DLC == 2))
    {
        ...
        if (nIndex < PDM_NUM_KEYPADS)
        {
            if (rx->DLC == 7)
            {
                ...
                conf->stKeypad[nIndex].nDimButtonBrightness = Dbc::DecodeInt(rx->data8, 48, 8);
            }
            ...
            Dbc::EncodeInt(tx->data8, conf->stKeypad[nIndex].nDimButtonBrightness, 48, 8);
        ...
        (rx->DLC == 2))
    {
        ...
        if (nIndex < PDM_NUM_KEYPADS)
        {
            if (rx->DLC == 8)
            {
                ...
                conf->stKeypad[nIndex].nDimmingVar = Dbc::DecodeInt(rx->data8, 40, 16);
                conf->stKeypad[nIndex].nButtonBrightness = Dbc::DecodeInt(rx->data8, 56, 8);
            }
            ...
            Dbc::EncodeInt(tx->data8, conf->stKeypad[nIndex].nDimmingVar, 40, 16);
            Dbc::EncodeInt(tx->data8, conf->stKeypad[nIndex].nButtonBrightness, 56, 8);
